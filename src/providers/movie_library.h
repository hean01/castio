...
#ifndef _movie_library_h
#define _movie_library_h

#include "provider.h"

cio_provider_descriptor_t *cio_provider_movie_library_new(struct cio_service_t *service);

#endif /* _movie_library_h */
